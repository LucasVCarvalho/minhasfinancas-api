...
import com.lvcarvalho.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.lvcarvalho.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	por usar o @RequiredArgs e classificar as variaveis como final 
	faz com que não precise desse construtor*/
	
	
	@GetMapping
	public ResponseEntity buscar(
			//@RequestParam java.util.Map<String, String> params pegaria todos os paramentos mas não daria pra configurar individualmente se eles eram obrigatorios.
